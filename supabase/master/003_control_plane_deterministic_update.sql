...
GRANT EXECUTE ON FUNCTION public.normalize_legacy_installation_operations(integer) TO service_role;CREATE OR REPLACE FUNCTION public.claim_stale_installation_operations(_owner text, _limit integer DEFAULT 3, _lease_seconds integer DEFAULT 180)
