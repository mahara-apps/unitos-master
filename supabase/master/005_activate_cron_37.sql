-- MASTER 1.4.23: ato mínimo para ativar exclusivamente o cron 37 já existente.
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    WHERE singleton IS TRUE AND current_version='1.4.23' AND pinned_release='1.4.23'
    ...
    RAISE EXCEPTION 'Contrato 1.4.23 ainda não está integralmente validado' USING ERRCODE='55000';
  END IF;
  IF EXISTS (
