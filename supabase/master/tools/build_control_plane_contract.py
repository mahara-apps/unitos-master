...
FILES=[ROOT/'master'/'002_control_plane_global_freeze.sql',ROOT/'master'/'003_control_plane_deterministic_update.sql',ROOT/'master'/'deterministic-update-install-preflight.sql',ROOT/'master'/'install-deterministic-update.sql']
