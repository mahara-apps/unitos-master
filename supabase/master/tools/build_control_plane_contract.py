...
def build():
 d={'schemaVersion':1,'releaseVersion':'1.4.19','operationStateCatalog':'operation-state-catalog.json','files':{p.name:sha(p) for p in FILES},'tables':TABLES,'functions':FUNCTIONS,'triggers':TRIGGERS}
