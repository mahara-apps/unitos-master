    ...
    IF _source_stage_progress IS NOT NULL THEN
      ...
      _inherited_detail := jsonb_set(
        ...
        jsonb_strip_nulls(jsonb_build_object(
          ...
          'provisionVercelProjectReady', _source_stage_progress->'provisionVercelProjectReady',
          'provisionVercelProjectId', _source_stage_progress->'provisionVercelProjectId',
          'provisionVercelTeamId', _source_stage_progress->'provisionVercelTeamId',
          'provisionRepositoryLinked', _source_stage_progress->'provisionRepositoryLinked',
          'provisionDeploymentId', _source_stage_progress->'provisionDeploymentId',
          'provisionDeploymentCommit', _source_stage_progress->'provisionDeploymentCommit',
          'provisionDeploymentState', _source_stage_progress->'provisionDeploymentState',
          'provisionDeploymentReadyAt', _source_stage_progress->'provisionDeploymentReadyAt',
          'provisionGitPushCommit', _source_stage_progress->'provisionGitPushCommit'
        )),
        true
      );
    END IF;
