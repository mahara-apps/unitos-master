...
- [ ] Corrigir na 1.4.30 a retomada para herdar o commit Git revalidável e nunca recriar REST quando ele existir.
- [ ] Validar a 1.4.30 pelo fluxo MASTER-first e publicar somente após autorização explícita.
