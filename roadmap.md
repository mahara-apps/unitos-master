...
- [ ] Materializar o bootstrap/convergência Master fora do pacote Client.
- [ ] Separar verificadores read-only Client e Master.
- [ ] Remover pré-requisitos Control-plane do executor do banco Client.
- [ ] Preservar mapa 115 (82 Client, 28 Control-plane, 3 Split, 2 Excluded) e pacote de 85 blocos.
- [ ] Sincronizar SHA 1.4.3 e executar todos os gates locais sem NEW, retry real ou publicação.
