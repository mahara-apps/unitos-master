...
const STOPWORDS = new Set([
  "a","o","os","as","de","do","da","dos","das","que","qual","quais","quanto","quantos","quantas",
  "para","por","com","em","no","na","nos","nas","e","é","são","foi","foram","um","uma","uns","umas",
  "meu","minha","nosso","nossa","hoje","ontem","este","esta","isso","isto","the","of","and","for","to",
]);
