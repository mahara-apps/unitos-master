...
export const Route = createFileRoute("/_portal/area/briefing")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Responda os briefings pendentes solicitados pela equipe da agência." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Briefing" },
      { property: "og:description", content: "Responda os briefings pendentes solicitados pela equipe da agência." },
