...
export const Route = createFileRoute("/_portal/area/aprovacoes")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Aprove a pauta do mês e os conteúdos da sua marca em um único fluxo." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Aprovações" },
      { property: "og:description", content: "Aprove a pauta do mês e os conteúdos da sua marca em um único fluxo." },
