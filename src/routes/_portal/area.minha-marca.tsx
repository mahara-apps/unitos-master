...
export const Route = createFileRoute("/_portal/area/minha-marca")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Consulte as informações da sua marca registradas pela equipe." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Minha Marca" },
      { property: "og:description", content: "Consulte as informações da sua marca registradas pela equipe." },
