...
export const Route = createFileRoute("/portal/$token/minha-marca")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Consulte as informações da sua marca usadas nos conteúdos." },
      { name: "robots", content: "noindex" },
      { property: "og:title", content: "Minha Marca" },
      { property: "og:description", content: "Consulte as informações da sua marca usadas nos conteúdos." },
